...
//  wkwebview
//
//  Created by Paolo Bernasconi on 10/27/16.
//  Copyright © 2016 Plaid LLC. All rights reserved.
//
...
class LinkViewController: UIViewController, WKNavigationDelegate {
    ...
    // createLinkUrl :: create the link.html url with query parameters
    func createLinkUrl() -> String {
        let config = [
            "key": "test_key",
            "product": "connect",
            "longtail": "true",
